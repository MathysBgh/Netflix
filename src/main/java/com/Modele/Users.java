...
public class Users {
    ...
    /**
     * Constructeur par défaut de la classe Users.
     */
    public Users() {
    }

    /**
     * Constructeur de la classe Users avec les paramètres spécifiés.
     * 
     * @param username Nom d'utilisateur
     * @param password Mot de passe
     * @param email    Adresse e-mail
     * @param role     Rôle de l'utilisateur (0 pour un utilisateur normal, 1 pour
     * 
    ...
    // CES DEUX FONCTIONS SONT lIER SOUVENT QUAND ON SUPPRIMME DANS UNE ON SUPPRIMME
    // DANS L'AUTRE
    // faire une fonction desactiver la reprise de film pour faire ca on supprime
    // tout les film vu
    // faire une fonction pour supprimmer l'historique ou certains film de
    // l'historique
